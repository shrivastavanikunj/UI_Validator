(function($){
    ...
    $.parser={auto:true,onComplete:function(_b){
        },plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","switchbutton","progressbar","tree","textbox","passwordbox","filebox","combo","combobox","combotree","combogrid","combotreegrid","tagbox","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","epanel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form"],parse:function(_c){
            var aa=[];
...
(function($){
    ...
    function _211(_212,_213){
        var _214=$.data(_212,"epanel");
        var opts=_214.options;
        var _215=_214.epanel;
        var _216=_215.children(".epanel-header");
        var _217=_215.children(".epanel-body");
        var _218=_215.children(".epanel-footer");
        ...
        if(!isNaN(parseInt(opts.height))){
            if(_219){
                ...
                var _21b=_216.find(".epanel-title");
                ...
                opts.epanelCssWidth=_215.css("width");
                if(opts.collapsed){
        ...
        $(_212).epanel("doLayout");
    };
    function _21e(_21f,_220){
        var _221=$.data(_21f,"epanel");
        var opts=_221.options;
        var _222=_221.epanel;
        if(_220){
            if(_220.left!=null){
                opts.left=_220.left;
            }
    ...
    function _223(_224){
        $(_224).addClass("epanel-body")._size("clear");
        var _225=$("<div class=\"epanel\"></div>").insertBefore(_224);
    ...
    function _227(_228){
        var _229=$.data(_228,"epanel");
        var opts=_229.options;
        var _22a=_229.epanel;
        _22a.css(opts.style);
        _22a.addClass(opts.cls);
        _22a.removeClass("epanel-hleft epanel-hright").addClass("epanel-h"+opts.halign);
        _22b();
        _22c();
        var _22d=$(_228).epanel("header");
        var body=$(_228).epanel("body");
        var _22e=$(_228).siblings(".epanel-footer");
        if(opts.border){
            _22d.removeClass("epanel-header-noborder");
            body.removeClass("epanel-body-noborder");
            _22e.removeClass("epanel-footer-noborder");
        }else{
            _22d.addClass("epanel-header-noborder");
            body.addClass("epanel-body-noborder");
            _22e.addClass("epanel-footer-noborder");
        }
        ...
        function _22b(){
            if(opts.noheader||(!opts.title&&!opts.header)){
                _210(_22a.children(".epanel-header"));
                _22a.children(".epanel-body").addClass("epanel-body-noheader");
            }else{
                if(opts.header){
                    $(opts.header).addClass("epanel-header").prependTo(_22a);
                }else{
                    var _22f=_22a.children(".epanel-header");
                    if(!_22f.length){
                        _22f=$("<div class=\"epanel-header\"></div>").prependTo(_22a);
                    }
                    if(!$.isArray(opts.tools)){
                        _22f.find("div.epanel-tool .epanel-tool-a").appendTo(opts.tools);
                    }
                    _22f.empty();
                    var _230=$("<div class=\"epanel-title\"></div>").html(opts.title).appendTo(_22f);
                    if(opts.iconCls){
                        _230.addClass("epanel-with-icon");
                        $("<div class=\"epanel-icon\"></div>").addClass(opts.iconCls).appendTo(_22f);
                    }
                    if(opts.halign=="left"||opts.halign=="right"){
                        _230.addClass("epanel-title-"+opts.titleDirection);
                    }
                    var tool=$("<div class=\"epanel-tool\"></div>").appendTo(_22f);
                    ...
                    if(opts.collapsible){
                        _231(tool,"epanel-tool-collapse",function(){
                    ...
                    if(opts.minimizable){
                        _231(tool,"epanel-tool-min",function(){
                            _257(_228);
                        });
                    }
                    if(opts.maximizable){
                        _231(tool,"epanel-tool-max",function(){
                    ...
                    if(opts.closable){
                        _231(tool,"epanel-tool-close",function(){
                            _243(_228);
                        });
                    }
                }
                _22a.children("div.epanel-body").removeClass("epanel-body-noheader");
            }
        };
        ...
        function _22c(){
            if(opts.footer){
                $(opts.footer).addClass("epanel-footer").appendTo(_22a);
                $(_228).addClass("epanel-body-nobottom");
            }else{
                _22a.children(".epanel-footer").remove();
                $(_228).removeClass("epanel-body-nobottom");
            }
        };
    };
    function _233(_234,_235){
        var _236=$.data(_234,"epanel");
        ...
        if(!_236.isLoaded||!opts.cache){
            ...
            if(opts.loadingMessage){
                $(_234).epanel("clear");
                $(_234).html($("<div class=\"epanel-loading\"></div>").html(opts.loadingMessage));
            }
    ...
    function _23b(_23c){
        $(_23c).epanel("doLayout",true);
    };
    function _23d(_23e,_23f){
        var opts=$.data(_23e,"epanel").options;
        var _240=$.data(_23e,"epanel").epanel;
        if(_23f!=true){
        ...
        function cb(){
            ...
            var tool=_240.children(".epanel-header").find("a.epanel-tool-restore");
            if(tool.length){
                opts.maximized=true;
            }
    ...
    function _243(_244,_245){
        var _246=$.data(_244,"epanel");
        var opts=_246.options;
        var _247=_246.epanel;
        if(_245!=true){
    ...
    function _248(_249,_24a){
        var _24b=$.data(_249,"epanel");
        var opts=_24b.options;
        var _24c=_24b.epanel;
        if(_24a!=true){
            if(opts.onBeforeDestroy.call(_249)==false){
                return;
            }
        }
        $(_249).epanel("clear").epanel("clear","footer");
        _210(_24c);
        opts.onDestroy.call(_249);
    };
    function _242(_24d,_24e){
        var opts=$.data(_24d,"epanel").options;
        var _24f=$.data(_24d,"epanel").epanel;
        var body=_24f.children(".epanel-body");
        var _250=_24f.children(".epanel-header");
        var tool=_250.find("a.epanel-tool-collapse");
        if(opts.collapsed==true){
            return;
        }
        body.stop(true,true);
        ...
        if(_24e==true){
            if(opts.halign=="left"||opts.halign=="right"){
                _24f.animate({width:_250._outerWidth()+_24f.children(".epanel-footer")._outerWidth()},function(){
                    cb();
                });
            }else{
            ...
            if(opts.halign=="left"||opts.halign=="right"){
                _24f._outerWidth(_250._outerWidth()+_24f.children(".epanel-footer")._outerWidth());
            }
            cb();
        }
        function cb(){
    ...
    function _251(_252,_253){
        var opts=$.data(_252,"epanel").options;
        var _254=$.data(_252,"epanel").epanel;
        var body=_254.children(".epanel-body");
        var tool=_254.children(".epanel-header").find("a.epanel-tool-collapse");
        ...
        if(_253==true){
            if(opts.halign=="left"||opts.halign=="right"){
                body.show();
                _254.animate({width:opts.epanelCssWidth},function(){
                    cb();
                });
            }else{
            ...
            if(opts.halign=="left"||opts.halign=="right"){
                _254.css("width",opts.epanelCssWidth);
            }
            cb();
        }
        function cb(){
    ...
    function _241(_255){
        var opts=$.data(_255,"epanel").options;
        var _256=$.data(_255,"epanel").epanel;
        var tool=_256.children(".epanel-header").find("a.epanel-tool-max");
        if(opts.maximized==true){
            return;
        }
        tool.addClass("epanel-tool-restore");
        if(!$.data(_255,"epanel").original){
            $.data(_255,"epanel").original={width:opts.width,height:opts.height,left:opts.left,top:opts.top,fit:opts.fit};
        }
        opts.left=0;
        opts.top=0;
        opts.fit=true;
    ...
    function _257(_258){
        var opts=$.data(_258,"epanel").options;
        var _259=$.data(_258,"epanel").epanel;
        _259._size("unfit");
        _259.hide();
        opts.minimized=true;
        opts.maximized=false;
    ...
    function _25a(_25b){
        var opts=$.data(_25b,"epanel").options;
        var _25c=$.data(_25b,"epanel").epanel;
        var tool=_25c.children(".epanel-header").find("a.epanel-tool-max");
        if(opts.maximized==false){
            return;
        }
        _25c.show();
        tool.removeClass("epanel-tool-restore");
        $.extend(opts,$.data(_25b,"epanel").original);
        _211(_25b);
        opts.minimized=false;
        opts.maximized=false;
        $.data(_25b,"epanel").original=null;
        opts.onRestore.call(_25b);
    };
    function _25d(_25e,_25f){
        $.data(_25e,"epanel").options.title=_25f;
        $(_25e).epanel("header").find("div.epanel-title").html(_25f);
    };
    var _260=null;
    ...
    $.fn.epanel=function(_262,_263){
        if(typeof _262=="string"){
            return $.fn.epanel.methods[_262](this,_263);
        }
        _262=_262||{};
        return this.each(function(){
            var _264=$.data(this,"epanel");
            var opts;
            if(_264){
                opts=$.extend(_264.options,_262);
                _264.isLoaded=false;
            }else{
                opts=$.extend({},$.fn.epanel.defaults,$.fn.epanel.parseOptions(this),_262);
                $(this).attr("title","");
                _264=$.data(this,"epanel",{options:opts,epanel:_223(this),isLoaded:false});
            }
            _227(this);
            $(this).show();
            if(opts.doSize==true){
                _264.epanel.css("display","block");
                _211(this);
            }
    ...
    $.fn.epanel.methods={options:function(jq){
            ...
            return jq.each(function(){
                _239(type=="footer"?$(this).epanel("footer"):this);
            });
        },refresh:function(jq,href){
            return jq.each(function(){
                var _269=$.data(this,"epanel");
                _269.isLoaded=false;
                if(href){
            ...
            return jq.each(function(){
                _26b(this,"body");
                _26b($(this).siblings(".epanel-footer")[0],"footer");
                function _26b(_26c,type){
                    if(!_26c){
                        return;
                    }
                    var _26d=_26c==$("body")[0];
                    var s=$(_26c).find("div.epanel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(function(_26e,el){
    ...
    $.fn.epanel.parseOptions=function(_272){
        var t=$(_272);
        var hh=t.children(".epanel-header,header");
        var ff=t.children(".epanel-footer,footer");
        return $.extend({},$.parser.parseOptions(_272,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header","footer","halign","titleDirection",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("epanel-header"):undefined),footer:(ff.length?ff.removeClass("epanel-footer"):undefined)});
    };
    $.fn.epanel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,halign:"top",titleDirection:"down",collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,openAnimation:false,openDuration:400,closeAnimation:false,closeDuration:400,tools:null,footer:null,header:null,queryParams:{},method:"get",href:null,loadingMessage:"Loading...",loader:function(_273,_274,_275){
...
(function($){
    ...
    function _296(_297){
        ...
        _298.window.draggable({handle:">div.epanel-header>div.epanel-title",disabled:_298.options.draggable==false,onBeforeDrag:function(e){
                if(_298.mask){
    ...
    $.fn.window.parseOptions=function(_2a6){
        return $.extend({},$.fn.epanel.parseOptions(_2a6),$.parser.parseOptions(_2a6,[{draggable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
    };
    $.fn.window.defaults=$.extend({},$.fn.epanel.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
    function _2a7(_2a8){
...
(function($){
    function _2ce(_2cf,_2d0){
        ...
        var _2d2=_2d1.epanels;
        var cc=$(_2cf);
        var _2d3=(opts.halign=="left"||opts.halign=="right");
        cc.children(".epanel-last").removeClass("epanel-last");
        cc.children(".epanel:last").addClass("epanel-last");
        if(_2d0){
        ...
        var _2d4=0;
        var _2d5="auto";
        var _2d6=cc.find(">.epanel>.accordion-header");
        if(_2d6.length){
            if(_2d3){
                $(_2d2[0]).epanel("resize",{width:cc.width(),height:cc.height()});
        ...
        function _2d7(_2d8,_2d9){
            ...
            for(var i=0;i<_2d2.length;i++){
                var p=_2d2[i];
                if(_2d3){
                    var h=p.epanel("header")._outerWidth(_2d4);
                }else{
                    var h=p.epanel("header")._outerHeight(_2d4);
                }
                if(p.epanel("options").collapsible==_2d8){
                    var _2db=isNaN(_2d9)?undefined:(_2d9+_2d4*h.length);
                    if(_2d3){
                        p.epanel("resize",{height:cc.height(),width:(_2d8?_2db:undefined)});
                        _2da+=p.epanel("epanel")._outerWidth()-_2d4*h.length;
                    }else{
                        p.epanel("resize",{width:cc.width(),height:(_2d8?_2db:undefined)});
                        _2da+=p.epanel("epanel").outerHeight()-_2d4*h.length;
                    }
                }
            }
            return _2da;
    ...
    function _2dc(_2dd,_2de,_2df,all){
        var _2e0=$.data(_2dd,"accordion").epanels;
        var pp=[];
        for(var i=0;i<_2e0.length;i++){
            var p=_2e0[i];
            if(_2de){
                if(p.epanel("options")[_2de]==_2df){
                    pp.push(p);
                }
            }else{
                if(p[0]==$(_2df)[0]){
    ...
    function _2e8(_2e9,_2ea){
        var _2eb=$.data(_2e9,"accordion").epanels;
    ...
    function _2f1(_2f2,pp,_2f3){
        ...
        pp.epanel($.extend({},{collapsible:true,minimizable:false,maximizable:false,closable:false,doSize:false,collapsed:true,headerCls:"accordion-header",bodyCls:"accordion-body",halign:opts.halign},_2f3,{onBeforeExpand:function(){
                ...
                var _2f4=$(this).epanel("header");
                _2f4.addClass("accordion-header-selected");
                _2f4.find(".accordion-collapse").removeClass("accordion-expand");
            },onExpand:function(){
                $(_2f2).find(">.epanel-last>.accordion-header").removeClass("accordion-header-border");
                if(_2f3.onExpand){
                    _2f3.onExpand.call(this);
                }
                opts.onSelect.call(_2f2,$(this).epanel("options").title,_2e5(_2f2,this));
            },onBeforeCollapse:function(){
                ...
                $(_2f2).find(">.epanel-last>.accordion-header").addClass("accordion-header-border");
                var _2f5=$(this).epanel("header");
                ...
                opts.onUnselect.call(_2f2,$(this).epanel("options").title,_2e5(_2f2,this));
            }}));
        var _2f6=pp.epanel("header");
        var tool=_2f6.children("div.epanel-tool");
    ...
    function _301(_302){
        ...
        $(_302).find(">.epanel-last>.accordion-header").addClass("accordion-header-border");
    ...
    function _2fe(_306){
        var _307=$.data(_306,"accordion").epanels;
    ...
    function _30c(_30d,_30e){
        ...
        var _310=_30f.epanels;
        _2fe(_30d);
        var _311=_2e8(_30d,_30e);
        var _312=_311.epanel("options").title;
    ...
    $.fn.accordion=function(_314,_315){
        ...
        return this.each(function(){
            ...
            if(_316){
                ...
                $.data(this,"accordion",{options:$.extend({},$.fn.accordion.defaults,$.fn.accordion.parseOptions(this),_314),accordion:$(this).addClass("accordion"),epanels:[]});
                init(this);
            }
            _2ec(this);
            _2ce(this);
    ...
    $.fn.accordion.methods={options:function(jq){
            ...
            return _2e3(jq[0]);
        },getepanel:function(jq,_318){
            return _2e8(jq[0],_318);
        },getepanelIndex:function(jq,_319){
...
(function($){
    ...
    function _336(_337,_338){
        ...
        var _33b=cc.children("div.tabs-epanels");
            ...
            if($(e.target).hasClass("tabs-scroller-left")){
                ...
                if($(e.target).hasClass("tabs-scroller-right")){
                    ...
                    if(a.length){
                        ...
                        if(li.length){
                            var _350=_34f(li);
                            var _351=_34e.tabs[_350].epanel("options");
                            if(_351.collapsible){
    ...
    function _353(_354){
        ...
        var _356=$(_354).children("div.tabs-epanels");
        _355.removeClass("tabs-header-top tabs-header-bottom tabs-header-left tabs-header-right");
        _356.removeClass("tabs-epanels-top tabs-epanels-bottom tabs-epanels-left tabs-epanels-right");
        if(opts.tabPosition=="top"){
            ...
            if(opts.tabPosition=="bottom"){
                ...
                _356.addClass("tabs-epanels-top");
            }else{
                if(opts.tabPosition=="left"){
                    _355.addClass("tabs-header-left");
                    _356.addClass("tabs-epanels-right");
                }else{
                    if(opts.tabPosition=="right"){
                        _355.addClass("tabs-header-right");
                        _356.addClass("tabs-epanels-left");
                    }
                }
            }
        }
        ...
        if(opts.border==true){
            ...
            _356.removeClass("tabs-epanels-noborder");
        }else{
            _355.addClass("tabs-header-noborder");
            _356.addClass("tabs-epanels-noborder");
        }
        opts.doSize=true;
    };
    function _357(_358,_359,pp){
        ...
        var _35b=$(_358).children("div.tabs-epanels");
        ...
        if(_359.index>=tabs.length){
            ...
            pp.insertBefore(_35b.children("div.epanel:eq("+_359.index+")"));
            tabs.splice(_359.index,0,pp);
        }
        pp.epanel($.extend({},_359,{tab:tab,border:false,noheader:true,closed:true,doSize:false,iconCls:(_359.icon?_359.icon:undefined),onLoad:function(){
                if(_359.onLoad){
                ...
                var _361=$(this).epanel("options");
                _35a.options.onUnselect.call(_358,_361.title,_362(_358,this));
            }}));
        $(_358).tabs("update",{tab:pp,options:pp.epanel("options"),type:"header"});
    };
    ...
    function _370(_371,_372){
        ...
        var _376=tab.epanel("options").title;
    ...
    function _375(_379,_37a,_37b){
        ...
        if(typeof _37a=="number"){
            ...
            for(var i=0;i<tabs.length;i++){
                var p=tabs[i];
                tmp.html(p.epanel("options").title);
                if(tmp.text()==_37a){
                    tab=p;
                    if(_37b){
                        tabs.splice(i,1);
    ...
    function _37e(_37f){
        ...
        var tabs=_380.tabs;
        for(var i=0;i<tabs.length;i++){
            var opts=tabs[i].epanel("options");
    ...
    function _383(_387){
        $(_387).children("div.tabs-epanels").each(function(){
            $(this).stop(true,true);
        });
    };
    ...
    $.fn.tabs.methods={options:function(jq){
            ...
            return jq.each(function(){
                var opts=$(this).tabs("getTab",_39b).epanel("options");
                opts.tab.removeClass("tabs-disabled");
                opts.disabled=false;
            });
        },disableTab:function(jq,_39c){
            return jq.each(function(){
                var opts=$(this).tabs("getTab",_39c).epanel("options");
                opts.tab.addClass("tabs-disabled");
                opts.disabled=true;
            });
...
(function($){
    ...
    function _3b0(_3b1,_3b2){
        ...
        _3b4.center.epanel("resize",cpos);
        function _3b5(pp,type){
            ...
            var _3b8=pp.epanel("epanel").outerHeight();
            pp.epanel("move",{left:0,top:(type=="n"?0:cc.height()-_3b8)});
            cpos.height-=_3b8;
            if(type=="n"){
                cpos.top+=_3b8;
        ...
        function _3b7(pp,type){
            ...
            var _3b9=pp.epanel("epanel").outerWidth();
            pp.epanel("move",{left:(type=="e"?cc.width()-_3b9:0),top:cpos.top});
            cpos.width-=_3b9;
            if(type=="w"){
                cpos.left+=_3b9;
                if(!opts.split&&opts.border){
    ...
    function init(_3ba){
        ...
        cc.addClass("layout");
        function _3bb(el){
            var _3bc=$.fn.layout.parseepanelOptions(el);
    ...
    function _3bf(_3c0,_3c1,el){
        ...
        var _3c2=$.data(_3c0,"layout").epanels;
        var cc=$(_3c0);
        var dir=_3c1.region;
        if(_3c2[dir].length){
            return;
        ...
        var _3c3=$.extend({},$.fn.layout.epaneldefaults,{width:(pp.length?parseInt(pp[0].style.width)||pp.outerWidth():"auto"),height:(pp.length?parseInt(pp[0].style.height)||pp.outerHeight():"auto"),doSize:false,collapsible:true,onOpen:function(){
            ...
            }},_3c1,{cls:((_3c1.cls||"")+" layout-epanel layout-epanel-"+dir),bodyCls:((_3c1.bodyCls||"")+" layout-body")});
        pp.epanel(_3c3);
        _3c2[dir]=pp;
        var _3c6={north:"s",south:"n",east:"w",west:"e"};
        var _3c7=pp.epanel("epanel");
        if(pp.epanel("options").split){
            _3c7.addClass("layout-split-"+dir);
        }
        _3c7.resizable($.extend({},{handles:(_3c6[dir]||""),disabled:(!pp.epanel("options").split),onStartResize:function(e){
                _3af=true;
        ...
        function _3cc(p){
            ...
            var _3d4=$.parser.parseValue(_3d2,_3c2[dir].epanel("options")[_3d2],$(_3c0));
            var _3d5=$.parser.parseValue(_3d1,_3d0.epanel("options")[_3d1],$(_3c0));
            var _3d6=_3d0.epanel("epanel")[_3d3]()-_3d5;
            if(_3b6(_3c2[_3cf])){
    ...
    function _3d7(_3d8,_3d9){
        var _3da=$.data(_3d8,"layout").epanels;
        if(_3da[_3d9].length){
            _3da[_3d9].epanel("destroy");
            _3da[_3d9]=$();
            var _3db="expand"+_3d9.substring(0,1).toUpperCase()+_3d9.substring(1);
            if(_3da[_3db]){
                _3da[_3db].epanel("destroy");
                _3da[_3db]=undefined;
            }
    ...
    function _3dc(_3dd,_3de,_3df){
        ...
        var _3e0=$.data(_3dd,"layout").epanels;
        var p=_3e0[_3de];
        var _3e1=p.epanel("options");
        ...
        if(!_3e0[_3e2]){
            _3e0[_3e2]=_3e3(_3de);
            var ep=_3e0[_3e2].epanel("epanel");
            if(!_3e1.expandMode){
                ...
                ep.bind("click",function(){
                    if(_3e1.expandMode=="dock"){
                        ...
                        var _3e4=_3e5();
                        p.epanel("resize",_3e4.collapse);
                        p.epanel("epanel").animate(_3e4.expand,function(){
        ...
        var _3e6=_3e5();
        if(!_3b6(_3e0[_3e2])){
            _3e0.center.epanel("resize",_3e6.resizeC);
        }
        p.epanel("epanel").animate(_3e6.collapse,_3df,function(){
            p.epanel("collapse",false).epanel("close");
            _3e0[_3e2].epanel("open").epanel("resize",_3e6.expandP);
            $(this).unbind(".layout");
        ...
        function _3e3(dir){
            ...
            if(!_3e1.hideCollapsedContent){
                ...
                isns?p.epanel("setTitle",_3e9):p.html(_3e9);
            }
        ...
        function _3e5(){
            var cc=$(_3dd);
            var _3ea=_3e0.center.epanel("options");
            var _3eb=_3e1.collapsedSize;
            if(_3de=="east"){
                var _3ec=p.epanel("epanel")._outerWidth();
                ...
                if(_3de=="west"){
                    ...
                    if(_3de=="north"){
                        var _3ee=p.epanel("epanel")._outerHeight();
                        var hh=_3ea.height;
                        if(!_3b6(_3e0.expandNorth)){
                            hh+=_3ee-_3eb+((_3e1.split||!_3e1.border)?1:0);
                        }
                        _3e0.east.add(_3e0.west).add(_3e0.expandEast).add(_3e0.expandWest).epanel("resize",{top:_3eb-1,height:hh});
                        ...
                        if(_3de=="south"){
                            ...
                            _3e0.east.add(_3e0.west).add(_3e0.expandEast).add(_3e0.expandWest).epanel("resize",{height:hh});
    ...
    function _3ef(_3f0,_3f1){
        var _3f2=$.data(_3f0,"layout").epanels;
        var p=_3f2[_3f1];
        var _3f3=p.epanel("options");
        if(_3f3.onBeforeExpand.call(p)==false){
            return;
        }
        var _3f4="expand"+_3f1.substring(0,1).toUpperCase()+_3f1.substring(1);
        if(_3f2[_3f4]){
            _3f2[_3f4].epanel("close");
            p.epanel("epanel").stop(true,true);
            p.epanel("expand",false).epanel("open");
            var _3f5=_3f6();
            p.epanel("resize",_3f5.collapse);
            p.epanel("epanel").animate(_3f5.expand,function(){
                _3b0(_3f0);
        ...
        function _3f6(){
            var cc=$(_3f0);
            var _3f7=_3f2.center.epanel("options");
            if(_3f1=="east"&&_3f2.expandEast){
                return {collapse:{left:cc.width(),top:_3f7.top,height:_3f7.height},expand:{left:cc.width()-p.epanel("epanel")._outerWidth()}};
            }else{
                if(_3f1=="west"&&_3f2.expandWest){
                    return {collapse:{left:-p.epanel("epanel")._outerWidth(),top:_3f7.top,height:_3f7.height},expand:{left:0}};
                }else{
                    if(_3f1=="north"&&_3f2.expandNorth){
                        return {collapse:{top:-p.epanel("epanel")._outerHeight(),width:cc.width()},expand:{top:0}};
                    }else{
                        if(_3f1=="south"&&_3f2.expandSouth){
                            return {collapse:{top:cc.height(),width:cc.width()},expand:{top:cc.height()-p.epanel("epanel")._outerHeight()}};
                        }
                    }
                }
            }
    ...
    function _3ff(_400,_401,_402){
        var p=$(_400).layout("epanel",_401);
        p.epanel("options").split=_402;
        var cls="layout-split-"+_401;
        var _403=p.epanel("epanel").removeClass(cls);
        if(_402){
            _403.addClass(cls);
        }
    ...
    $.fn.layout=function(_404,_405){
        ...
        return this.each(function(){
            ...
            if(_406){
                ...
                $.data(this,"layout",{options:opts,epanels:{center:$(),north:$(),south:$(),east:$(),west:$()}});
                init(this);
            }
            _3b0(this);
            _3f8(this);
    ...
    $.fn.layout.methods={options:function(jq){
        ...
        },epanel:function(jq,_408){
            return $.data(jq[0],"layout").epanels[_408];
            ...
            return jq.each(function(){
                _3bf(this,_40b);
                _3b0(this);
                if($(this).layout("epanel",_40b.region).epanel("options").collapsed){
    ...
    $.fn.layout.parseepanelOptions=function(_414){
        var t=$(_414);
        return $.extend({},$.fn.epanel.parseOptions(_414),$.parser.parseOptions(_414,["region",{split:"boolean",collpasedSize:"number",minWidth:"number",minHeight:"number",maxWidth:"number",maxHeight:"number"}]));
    };
    $.fn.layout.epaneldefaults=$.extend({},$.fn.epanel.defaults,{region:null,split:false,collapsedSize:28,expandMode:"float",hideExpandTool:false,hideCollapsedContent:true,collapsedContent:function(_415){
            var p=$(this);
            var opts=p.epanel("options");
            if(opts.region=="north"||opts.region=="south"){
                return _415;
            }
            var cc=[];
            if(opts.iconCls){
                cc.push("<div class=\"epanel-icon "+opts.iconCls+"\"></div>");
            }
            cc.push("<div class=\"epanel-title layout-expand-title");
...
(function($){
    ...
    function _65a(_65b,_65c){
        ...
        var _65e=_65d.epanel;
        if(_65c){
            $.extend(opts,_65c);
        }
        if(opts.fit==true){
            var p=_65e.epanel("epanel").parent();
            opts.width=p.width();
            opts.height=p.height();
        }
        _65e.epanel("resize",opts);
    };
    function _65f(_660){
        var _661=$.data(_660,"datagrid");
        var opts=_661.options;
        var dc=_661.dc;
        var wrap=_661.epanel;
        var _662=wrap.width();
    ...
    function _684(_685,_686){
        ...
        _68a.epanel({doSize:false,cls:"datagrid"});
    ...
    $.fn.datagrid=function(_7cb,_7cc){
        ...
        return this.each(function(){
            ...
            if(_7cd){
                ...
                $.data(this,"datagrid",{options:opts,epanel:_7ce.epanel,dc:_7ce.dc,ss:null,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
            }
            _68d(this);
            _6a4(this);
            _65a(this);
    ...
    $.fn.datagrid.methods={options:function(jq){
            ...
            var _7f7=$.data(jq[0],"datagrid").epanel.epanel("options");
            ...
            return _64b(jq[0]);
        },getepanel:function(jq){
            return $.data(jq[0],"datagrid").epanel;
        },getPager:function(jq){
            return $.data(jq[0],"datagrid").epanel.children("div.datagrid-pager");
            ...
            return jq.each(function(){
                ...
                if(opts.loadMsg){
                    var _7ff=$(this).datagrid("getepanel");
            ...
            return jq.each(function(){
                ...
                var _800=$(this).datagrid("getepanel");
            ...
            return jq.each(function(){
                ...
                if(col.hidden){
                    col.hidden=false;
                    $(this).datagrid("getepanel").find("td[field=\""+_81e+"\"]").show();
                    _6e1(this,_81e,1);
            ...
            return jq.each(function(){
                ...
                if(!col.hidden){
                    col.hidden=true;
                    $(this).datagrid("getepanel").find("td[field=\""+_81f+"\"]").hide();
                    _6e1(this,_81f,-1);
                    $(this).datagrid("fitColumns");
                }
            });
    ...
    var _826={render:function(_827,_828,_829){
            ...
            if(opts.showFooter){
                var _865=$(_863).datagrid("getepanel").find("div.datagrid-footer");
...
(function($){
    ...
    $(document).unbind(".propertygrid").bind("mousedown.propertygrid",function(e){
        var p=$(e.target).closest("div.datagrid-view,div.combo-epanel");
        if(p.length){
            return;
        }
        _8a7(_8a6);
...
(function($){
    ...
    function _905(_93e,_93f,_940,_941,_942){
        ...
        var body=$(_93e).datagrid("getepanel").find("div.datagrid-body");
    ...
    function _981(_982){
        ...
        if(opts.lines){
            t.treegrid("getepanel").addClass("tree-lines");
        }else{
            t.treegrid("getepanel").removeClass("tree-lines");
            return;
        }
        t.treegrid("getepanel").find("span.tree-indent").removeClass("tree-line tree-join tree-joinbottom");
        t.treegrid("getepanel").find("div.datagrid-cell").removeClass("tree-node-last tree-root-first tree-root-one");
...
(function($){
    ...
    function _a09(_a0a){
        ...
        if(!_a0b.epanel){
            _a0b.epanel=$("<div class=\"combo-epanel\"></div>").appendTo("body");
            _a0b.epanel.epanel({minWidth:opts.epanelMinWidth,maxWidth:opts.epanelMaxWidth,minHeight:opts.epanelMinHeight,maxHeight:opts.epanelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
                    var _a0c=$(this).epanel("options").comboTarget;
                    var _a0d=$.data(_a0c,"combo");
                    if(_a0d){
                        _a0d.options.onShowepanel.call(_a0c);
                    }
                },onBeforeClose:function(){
                    _a08($(this).parent());
                },onClose:function(){
                    var _a0e=$(this).epanel("options").comboTarget;
                    var _a0f=$(_a0e).data("combo");
                    if(_a0f){
                        _a0f.options.onHideepanel.call(_a0e);
                    }
                }});
        }
    ...
    function _a14(_a15){
        var _a16=$.data(_a15,"combo").epanel;
        if(_a16.is(":visible")){
            var _a17=_a16.combo("combo");
            _a18(_a17);
            if(_a17!=_a15){
                $(_a15).combo("showepanel");
            }
        }else{
            var p=$(_a15).closest("div.combo-p").children(".combo-epanel");
            $("div.combo-epanel:visible").not(_a16).not(p).epanel("close");
            $(_a15).combo("showepanel");
        }
    ...
    function _a1a(e){
        ...
        if(!opts.editable){
            ...
            var p=$(_a1b).closest("div.combo-p").children(".combo-epanel");
            $("div.combo-epanel:visible").not(p).each(function(){
    ...
    function _a1e(e){
        ...
        _a20.epanel.epanel("options").comboTarget=_a1f;
        switch(e.keyCode){
            case 38:
    ...
    function _a21(_a22){
        ...
        var _a24=_a23.combo;
        var _a25=_a23.epanel;
        var opts=$(_a22).combo("options");
        var _a26=_a25.epanel("options");
        _a26.comboTarget=_a22;
        if(_a26.closed){
            _a25.epanel("epanel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
            _a25.epanel("resize",{width:(opts.epanelWidth?opts.epanelWidth:_a24._outerWidth()),height:opts.epanelHeight});
            _a25.epanel("epanel").hide();
            _a25.epanel("open");
        }
        (function _fixCombo(){
            if(_a26.comboTarget==_a22&&_a25.is(":visible")){
                _a25.epanel("move",{left:_a27(),top:_a28()});
    ...
    function _a18(_a29){
        var _a2a=$.data(_a29,"combo").epanel;
        _a2a.epanel("close");
    };
    ...
    $.fn.combo.methods={options:function(jq){
            ...
            return jq.each(function(){
                ...
                $.data(this,"combo",{options:$.extend(true,{cloned:true},$(from).combo("options")),combo:$(this).next(),epanel:$(from).combo("epanel")});
                $(this).addClass("combo-f").attr("comboName",$(this).attr("textboxName"));
            });
        },combo:function(jq){
            return jq.closest(".combo-epanel").epanel("options").comboTarget;
        },epanel:function(jq){
    ...
    $.fn.combo.parseOptions=function(_a4d){
        var t=$(_a4d);
        return $.extend({},$.fn.textbox.parseOptions(_a4d),$.parser.parseOptions(_a4d,["separator","epanelAlign",{epanelWidth:"number",hasDownArrow:"boolean",delay:"number",reversed:"boolean",multivalue:"boolean",selectOnNavigation:"boolean"},{epanelMinWidth:"number",epanelMaxWidth:"number",epanelMinHeight:"number",epanelMaxHeight:"number"}]),{epanelHeight:(t.attr("epanelHeight")=="auto"?"auto":parseInt(t.attr("epanelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
    };
    $.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_a1a,keydown:_a1e,paste:_a1e,drop:_a1e},epanelWidth:null,epanelHeight:200,epanelMinWidth:null,epanelMaxWidth:null,epanelMinHeight:null,epanelMaxHeight:null,epanelAlign:"left",reversed:false,multiple:false,multivalue:true,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
            },down:function(e){
            },left:function(e){
            },right:function(e){
            },enter:function(e){
...
(function($){
    ...
    function _a6d(_a6e,data,_a6f){
        ...
        opts.view.render.call(opts.view,_a6e,$(_a6e).combo("epanel"),_a70.data);
    ...
    function _a81(_a82){
        ...
        $(_a82).combo($.extend({},opts,{onShowepanel:function(){
                $(this).combo("epanel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
                _a61(this,$(this).combobox("getValues"),true);
                $(this).combobox("scrollTo",$(this).combobox("getValue"));
                opts.onShowepanel.call(this);
            }}));
        var p=$(_a82).combo("epanel");
        p.unbind(".combobox");
        for(var _a84 in opts.epanelEvents){
            p.bind(_a84+".combobox",{target:_a82},opts.epanelEvents[_a84]);
        }
    };
    function _a85(e){
    ...
    function _a87(e){
        var _a88=$(this).epanel("options").comboTarget;
        if(!_a88){
            return;
        }
        ...
        if(opts.multiple){
            ...
            $(_a88).combobox("setValue",_a89).combobox("hideepanel");
        }
        e.stopPropagation();
    };
    function _a8a(e){
        var _a8b=$(this).epanel("options").comboTarget;
        if(!_a8b){
            return;
        }
    ...
    $.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupPosition:"static",groupField:null,groupFormatter:function(_aa5){
            ...
            }}),epanelEvents:{mouseover:_a85,mouseout:_a86,click:_a87,scroll:_a8a},filter:function(q,row){
            var opts=$(this).combobox("options");
...
(function($){
    function _abc(_abd){
        ...
        $(_abd).combo($.extend({},opts,{onShowepanel:function(){
                if(opts.editable){
                    tree.tree("doFilter","");
                }
                opts.onShowepanel.call(this);
            }}));
        var _abf=$(_abd).combo("epanel");
        if(!tree){
...
(function($){
    function _ae2(_ae3){
        ...
        var grid=_ae4.grid;
        $(_ae3).addClass("combogrid-f").combo($.extend({},opts,{onShowepanel:function(){
                _af9(this,$(this).combogrid("getValues"),true);
                var p=$(this).combogrid("epanel");
                var _ae5=p.outerHeight()-p.height();
                var _ae6=p._size("minHeight");
                var _ae7=p._size("maxHeight");
                var dg=$(this).combogrid("grid");
                dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.epanelHeight))?"auto":"100%"),minHeight:(_ae6?_ae6-_ae5:""),maxHeight:(_ae7?_ae7-_ae5:"")});
        ...
        function _aec(dg){
            return $(dg).closest(".combo-epanel").epanel("options").comboTarget||_ae3;
        };
        function _ae9(data){
            var _aed=_aec(this);
    ...
    $.fn.combogrid.methods={options:function(jq){
            ...
            return jq.each(function(){
                $(this).combo("cloneFrom",from);
                $.data(this,"combogrid",{options:$.extend(true,{cloned:true},$(from).combogrid("options")),combo:$(this).next(),epanel:$(from).combo("epanel"),grid:$(from).combogrid("grid")});
            });
        },grid:function(jq){
...
(function($){
    function _b24(_b25){
        ...
        $(_b25).addClass("combotreegrid-f").combo($.extend({},opts,{onShowepanel:function(){
                var p=$(this).combotreegrid("epanel");
                var _b27=p.outerHeight()-p.height();
                var _b28=p._size("minHeight");
                var _b29=p._size("maxHeight");
                var dg=$(this).combotreegrid("grid");
                dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.epanelHeight))?"auto":"100%"),minHeight:(_b28?_b28-_b27:""),maxHeight:(_b29?_b29-_b27:"")});
...
(function($){
    function _b81(_b82){
        ...
        $(_b82).addClass("datebox-f").combo($.extend({},opts,{onShowepanel:function(){
                _b84(this);
                _b85(this);
                _b86(this);
        ...
        if(!_b83.calendar){
            var _b87=$(_b82).combo("epanel").css("overflow","hidden");
            _b87.epanel("options").onBeforeDestroy=function(){
    ...
    $.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{epanelWidth:180,epanelHeight:"auto",sharedCalendar:null,keyHandler:{up:function(e){
            },down:function(e){
            },left:function(e){
            },right:function(e){
            },enter:function(e){
                ...
                $(this).closest("div.combo-epanel").epanel("close");
            }}],formatter:function(date){
...
(function($){
    function _bab(_bac){
        ...
        $(_bac).datebox($.extend({},opts,{onShowepanel:function(){
